...
class TripViewModel : ViewModel() {
    ...
    fun editTrip(context: Context, db: FirebaseFirestore, tripId: String, newTripUri: String,  newTripName: String, newTripLength: String, newTripFees: Double, newTripDeposit: Double, newTripDesc: String, newDeptDate: String, newRetDate: String, newOptions: List<String>){
